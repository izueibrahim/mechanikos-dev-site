...
export default async function Career() {
  ...
  return (
    <RootLayout globalData={globalData}>
      ...
      >
        <p>
        Ready for the paradigm shift? Kick start a career fueled by innovation and technology.
        Contact us today and you can be part of the culture of “Engaging People, Driving Performance”.
        </p>
      </PageIntro>
